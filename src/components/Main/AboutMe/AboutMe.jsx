    ...
    return (
        <section id='about-me' className='about-me'>
            ...
            <article className='about-me__article'>
                <h3 className='about-me__heading article-heading'>Виталий</h3>
                <span className='about-me__span'>Фронтенд-разработчик, 30 лет</span>
                <p className='about-me__text article'>Я родился и живу в Саратове, закончил факультет экономики СГУ.
